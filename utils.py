...
class DroneDataGenerator(ImageDataGenerator):
    ...
    def flow_from_directory(self, directory, target_size=(224,224),
        ...
        """
        :param directory:   FLAGS.train_dir ./dataset/drone-data-train
        :param target_size: (FLAGS.img_height, FLAGS.img_width) (225, 400)
        :param crop_size:   (FLAGS.crop_img_height_dronet, FLAGS.crop_img_width_dronet) (200, 200)
        :param color_mode:  FLAGS.img_mode  grayscale
        :param batch_size:  FLAGS.batch_size 5
        :param shuffle:     True
        :param seed:
        :param follow_links:
        :return:
...
def sparse_categorical_crossentropy_o(y_true, parameters):
    ...
    if n_samples == 0:
        ...
        loss = keras.losses.sparse_categorical_crossentropy(y_true[:, 1],parameters)
...
def orient_acc(y_true, parameters):
    ...
    if n_samples == 0:
        ...
        acc = keras.metrics.sparse_categorical_accuracy(y_true[:, 1],parameters)
