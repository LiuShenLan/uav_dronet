...
gflags.DEFINE_integer('crop_img_width_dronet', 200, 'Cropped image widht of resnet')
gflags.DEFINE_integer('crop_img_height_dronet', 200, 'Cropped image height of resnet')
...
gflags.DEFINE_string('weights_fname', "model_weights_239.h5", '(Relative) filename of model weights')
