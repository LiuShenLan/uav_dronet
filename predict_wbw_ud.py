...
def main():
    ...
    json_model_path = sys.path[0] + '/model/newtrain/model_struct.json'
    weights_path = sys.path[0] + '/model/newtrain/model_weights_149.h5'
...
#    model = utils.jsonToModel(json_model_path)
    model = cnn_models.conv_MDN_resnet_trans(crop_img_width,crop_img_height,3,1)
